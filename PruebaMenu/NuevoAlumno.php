...
<nav class="navbar navbar-expand-lg navbar-light bg-light px-5">
    ...
    <!-- FORMULARIO DEL ALUMNO -->
        <form method="POST">
            <h1>Nuevo Alumno</h1>
            <input type="number" name="Matricula"  placeholder="Su matricula"><br>
            <br><input type="text" name="Nombre" max="20" placeholder="Su nombre"><br>
            <br><input type="text" name="Apellidos" max="20" placeholder="apellido paterno"><br>
            <br><input type="text" name="Dirección" max="50" placeholder="su direccion ej. el coloso"><br>
            <br><input type="text" name="Población" max="50" placeholder="ej. Acapulco. Gro"><br>
